...
// ============================================================
const { getJogador, salvarJogador, adicionarMoedas, adicionarXP, adicionarConquista, formatarBelarium } = require('./db');
...
function comprarItem(jogador_id, item_nome) {
  ...
  if (jogador.moedas < alvo.preco) return `❌ Belarium insuficiente! Você tem ${formatarBelarium(jogador)}, precisa de *${alvo.preco}* 🥉 Bronze.`;
