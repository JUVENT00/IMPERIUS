...
${S.baixo}`;
    try { await sock.sendMessage(jid, { image: { url: 'https://raw.githubusercontent.com/JUVENTOO/IMPERIUS/main/IMG-20260508-WA0008.jpg' }, caption: menu_txt }); } catch { await sock.sendMessage(jid, { text: menu_txt }); }
    return;
  }
  // ── MENU OLD ──────────────────────────────────────────────
  if (cmd === 'menu_SKIP') {
