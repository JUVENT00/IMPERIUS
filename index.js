...
const { verRanking, verConquistas, verTitulos, usarTitulo, verMissoes, progredirMissao, coletarMissao, matarJogador, darItem, abencoarJogador, maldicionarJogador, eventoGlobal, statusBot } = require('./events');
...
const { CLASSES, ARMAS, ARMADURAS, ARMAS_PRIMORDIAIS, REGIOES, ITENS_LOJA } = require('./gameData');
