...
const { batalharMonstro, batalharBoss, pvp, usarHabilidade, usarUltimate, rolarD20, rand, gerarMonstro, gerarBoss, bossesDaRegiao, faseAtualBoss, calcularDanoBase, calcularDefesa, aplicarPassivaClasse, getResultadoD20, usarHabilidadeArma, usarSupremaArma } = require('./combat');
...
const { verRanking, verRankingConquistas, verConquistas, verTitulos, verTitulosDisponiveis, usarTitulo, verMissoes, progredirMissao, coletarMissao, matarJogador, darItem, abencoarJogador, maldicionarJogador, eventoGlobal, statusBot } = require('./events');
