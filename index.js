...
${S.baixo}`;
  ...
  if (cmd === 'd20') {
    ...
    const img_d20 = require('path').join(__dirname, 'd20', `d${d}.jpg`);
    if (require('fs').existsSync(img_d20)) {
      await sock.sendMessage(jid, { image: require('fs').readFileSync(img_d20), caption: txt_d20, mimetype: 'image/jpeg' });
    } else {
