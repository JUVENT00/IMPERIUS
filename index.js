...
${S.baixo}`;
  ...
  if (cmd === 'comprar' && resto && (resto[0] === '#' || resto[0] === '$' || resto[0] === '@' || resto[0] === '!')) {
    ...
    const CODIGOS = {
      ...
      '!': {
        'IPP': 'pocao_hp_p', 'IPM': 'pocao_hp_m', 'IPG': 'pocao_hp_g', 'IPX': 'pocao_hp_maxima',
        'IMP': 'pocao_mana_p', 'IMG': 'pocao_mana_g', 'IMT': 'pocao_mana_total',
        'IAN': 'antidoto', 'IPU': 'purificador',
        'IEF': 'elixir_forca', 'IPR': 'pedra_ressurreicao',
        'IXP': 'pocao_xp', 'IAS': 'amuleto_sorte',
        'IPT': 'pergaminho_teletransporte', 'IEN': 'elixir_nivel'
      },
      '@': {
        // Contato
