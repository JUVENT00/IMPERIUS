...
const { verLojaOvos, chocarOvo, verPet, soltarPet, curarPet, petAjudaBatalha, tentarDomar, nomearPet, comprarOvo, gerarEstado, ITENS_DOMAR, CRIATURAS, ESTADOS, ehAnimalSelvagem, tentarDomarAnimal, chamarPet, chamarAnimalBatalha, verAnimais, verMeuAnimal, soltarAnimal, adotarAnimal } = require('./pets');
...
${S.baixo}`;
  ...
  if (cmd === 'mapa') {
    return enviar(jid, bloco('𝐌𝐀𝐏𝐀 𝐃𝐎 𝐈𝐌𝐏𝐄𝐑𝐈𝐔𝐒 【🗺️】', [
      '☁️ Céu Flutuante de Solvaryn',
      '❄️ Tundra de Voryn',
      '❄️ Cavernas de Gelo Eterno',
      '⛰️ Pico de Kaldros',
      '🏔️ Serra dos Titãs',
      '🐉 Montanha do Dragão',
      '🌲 Floresta de Eryndal',
      ...
      '🌊 Ilhas de Marveth',
      '🌀 Abismo do Mar Negro',
      '⛪ Necrópole de Draktum',
      '🌿 Pântano Maldito',
      '🗼 Torre do Caos',
      '🌋 Vulcão de Ignareth',
      '🔥 Planícies de Cinzas',
      '🏜️ Deserto de Aresh',
      '🏜️ Dunas do Esquecimento',
      '━━━━━━━━━━',
      '💡 /viajar Floresta de Eryndal',
