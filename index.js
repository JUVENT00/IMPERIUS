...
const { verLojaOvos, chocarOvo, verPet, soltarPet, curarPet, petAjudaBatalha, tentarDomar, nomearPet, comprarOvo, gerarEstado, ITENS_DOMAR, CRIATURAS, ESTADOS } = require('./pets');
...
${S.baixo}`;
  ...
  if (cmd === 'tentardomar') {
    ...
    let escolhida = criaturas_regiao.find(([_, c]) => c.nome.toLowerCase().includes((b_dom?.monstro_nome || '').toLowerCase()));
  ...
  if (cmd === 'renascer') {
    ...
    await enviar(jid, bloco('✨ O DEUS PERMITIU 【🌟】', [
