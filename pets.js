...
const OVOS = {
  // ── BÁSICOS ──────────────────────────────────────────
  'ovo comum':       { preco: 80,    raridade_base: 'comum',     chance_raro: 10,  descricao: 'Um ovo simples e frágil' },
  'ovo floresta':    { preco: 200,   raridade_base: 'incomum',   chance_raro: 25,  descricao: 'Um ovo encontrado nas florestas antigas', tipos: ['besta', 'ave'] },
  'ovo pantanoso':   { preco: 250,   raridade_base: 'incomum',   chance_raro: 25,  descricao: 'Um ovo coberto de lodo antigo', tipos: ['reptil', 'aquatico'] },
  'ovo das ruinas':  { preco: 300,   raridade_base: 'incomum',   chance_raro: 30,  descricao: 'Um ovo encontrado em ruínas milenares', tipos: ['espirito', 'besta'] },

  // ── INTERMEDIÁRIOS ────────────────────────────────────
  'ovo trevas':      { preco: 450,   raridade_base: 'raro',      chance_raro: 30,  descricao: 'Um ovo negro como a noite eterna', tipos: ['espirito', 'elemental'] },
  'ovo abismo':      { preco: 500,   raridade_base: 'raro',      chance_raro: 35,  descricao: 'Um ovo trazido das profundezas', tipos: ['aquatico', 'reptil'] },
  'ovo fogo':        { preco: 480,   raridade_base: 'raro',      chance_raro: 30,  descricao: 'Um ovo quente como brasa viva', tipos: ['elemental', 'dragao'] },
  'ovo gelo':        { preco: 480,   raridade_base: 'raro',      chance_raro: 30,  descricao: 'Um ovo gelado como neve eterna', tipos: ['elemental', 'reptil'] },
  'ovo tempestade':  { preco: 550,   raridade_base: 'raro',      chance_raro: 35,  descricao: 'Um ovo que faísca de energia', tipos: ['ave', 'elemental'] },
  'ovo espectral':   { preco: 600,   raridade_base: 'raro',      chance_raro: 40,  descricao: 'Um ovo translúcido e etéreo', tipos: ['espirito'] },

  // ── AVANÇADOS ─────────────────────────────────────────
  'ovo maldito':     { preco: 900,   raridade_base: 'epico',     chance_raro: 50,  descricao: 'Um ovo marcado por uma antiga maldição' },
  'ovo sagrado':     { preco: 1200,  raridade_base: 'epico',     chance_raro: 60,  descricao: 'Um ovo abençoado pelos deuses antigos', tipos: ['espirito', 'ave'] },
  'ovo dracônico':   { preco: 1500,  raridade_base: 'epico',     chance_raro: 65,  descricao: 'Um ovo coberto de escamas dracônicas', tipos: ['dragao', 'reptil'] },
  'ovo caos':        { preco: 1800,  raridade_base: 'aleatorio', chance_raro: 70,  descricao: 'Um ovo imprevisível — qualquer raridade!' },

  // ── RAROS ─────────────────────────────────────────────
  'ovo lendario':    { preco: 5000,  raridade_base: 'lendario',  chance_raro: 100, descricao: 'Um ovo de criatura lendária garantida' },
  'ovo ancestral':   { preco: 8000,  raridade_base: 'ancestral', chance_raro: 100, descricao: 'Um ovo de era ancestral' },
  'ovo primordial':  { preco: 15000, raridade_base: 'primordial',chance_raro: 100, descricao: 'Um ovo do início dos tempos' },
...
function chocarOvo(jogador_id, tipo_ovo) {
  ...
  const ovo_key = tipo_ovo.toLowerCase().trim();
