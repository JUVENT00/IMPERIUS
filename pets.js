...
const CRIATURAS = {
  ...
  wyvern_ancia:   { nome: '🐉 Wyvern Anciã',      tipo: 'dragao',   raridade: 'ancestral',  regiao: 'montanha_dragao',   dano: [200,280], habilidade: 'Voo Rasante — ataca duas vezes antes do inimigo reagir', lore: 'Dragão menor europeu, ancestral distante dos grandes dragões, temido por vilarejos inteiros.' },
