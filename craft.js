...
// ============================================================
const { getJogador, salvarJogador, formatarBelarium } = require('./db');
...
function craftar(jogador_id, nome_receita) {
  ...
  if ((j.moedas || 0) < receita.moedas) {
    return { erro: `❌ Você precisa de 🥉 ${receita.moedas} Bronze pra craftar isso! Você tem ${formatarBelarium(j)}.` };
  }
