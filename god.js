...
function deusDescansar(dono_id, jid) {
  ...
  if (campeao && ARMAS_RARAS_DROP.length > 0) {
    ...
    if (j_campeao) {
      ...
      // O inventário só guarda o id (string) do item — igual em todo o
      // resto do jogo (economy.js, combat.js, craft.js). Empurrar o objeto
      // inteiro aqui é o que fazia aparecer "[object Object]" no /inventario.
      j_campeao.inventario.push(arma_drop.id);
