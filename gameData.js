...
const ARMAS = [
  ...
  { id: "faca_bolso_escarlate", nome: "🗡️ Faca de Bolso Escarlate", dano: [500,500], raridade: "🩸 Personalizada", preco: 0, exclusiva: true },
  { id: "alabarda_do_rei", nome: "⚜️ Alabarda do Rei", dano: [900,1150], raridade: "🩸 Personalizada", preco: 0, exclusiva: true },
...
const ITENS_LOJA = [
  ...
  { id: 'pocao_xp', nome: '📚 Poção de XP', preco: 800, efeito: 'xp', valor: 500, exclusiva: true, descricao: 'Não é vendida em nenhuma loja. Drop raro de Bosses.' },
  { id: 'amuleto_sorte', nome: '🍀 Amuleto da Sorte', preco: 1500, efeito: 'buff_sorte', valor: 20, duracao: 5 },
  { id: 'pergaminho_teletransporte', nome: '📜 Pergaminho de Teletransporte', preco: 300, efeito: 'teletransporte', exclusiva: true, descricao: 'Não é vendido em nenhuma loja. Drop raro de Bosses. Teleporta você para um local aleatório.' },
